...
public class DefaultApplicationDeployer extends AbstractDeployer<ApplicationModel> implements ApplicationDeployer {
    ...
    public void initialize() {
        ...
        // 不一定说多个线程都是并发访问这个initialize这个方法
        // 主要是为了避免在执行initialize方法的时候，还有其他线程访问别的方法
        // 也可以用synchronized (startLock) 加锁卡住，等待你的这个线程initialize方法执行完了再执行
